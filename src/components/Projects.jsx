      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="p-6 rounded-lg shadow-lg w-full bg-gradient-to-r from-gray-500 to-gray-900 text-white">
          ...
          <div className="mt-4 flex gap-4">
            ...
            <a href="https://imaginative-babka-1d63b7.netlify.app" className="flex items-center gap-2 px-4 py-2 border rounded-lg text-white bg-blue-500 hover:bg-blue-600 transition">
