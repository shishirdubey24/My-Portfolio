...
const Skill = () => {
  ...
  return (
    <div id="project" className="font-medium p-6 mt-70">
      ...
      <div
        id="skill"
        className="mt-40 font-medium flex flex-wrap space-x-10 justify-center p-6 bg-gray-50 rounded-lg shadow-md"
      >
        ...
        <div className="p-4 rounded-lg shadow-md w-64">
          ...
          <div className="grid grid-cols-2 gap-3 mt-3">
            <button className={buttonClass}>TypeScript</button>
        ...
        <div className="p-4 rounded-lg shadow-md w-64">
          ...
          <div className="grid grid-cols-2 gap-3 mt-3">
            <button className={buttonClass}>React.js</button>
            <button className={buttonClass}>Redux</button>
          </div>
          <div className="grid grid-cols-2 gap-3 mt-3">
            <button className={buttonClass}>React Router</button>
            <button className={buttonClass}>Next.js</button>
          </div>
          <div className="grid grid-cols-2 gap-3 mt-3">
            <button className={buttonClass}>Node.js</button>
            <button className={buttonClass}>Express.js</button>
          </div>
          <div className="grid grid-cols-2 gap-3 mt-3">
            <button className={buttonClass}>Shadcn/UI</button>
          </div>
        </div>
        ...
        <div className="p-4 rounded-lg shadow-md w-64">
          ...
          <div className="grid grid-cols-2 gap-3 mt-3">
            <button className={buttonClass}>AWS</button>
            <button className={buttonClass}>Vite</button>
          </div>
          <div className="grid grid-cols-2 gap-3 mt-3">
            <button className={buttonClass}>Cursor (GenAI)</button>
            <button className={buttonClass}>Vibe Coding</button>
          </div>
        </div>
