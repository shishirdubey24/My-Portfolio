      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1 animate-fade-in-up">
           <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#1e293b] border border-gray-600 rounded-full text-gray-300 text-sm font-medium mb-6 animate-fade-in-down delay-300">
...
<div className="order-1 lg:order-2 flex justify-center lg:justify-end animate-scale-in-rotate delay-500">
  <div className="relative">
    ...
    <div className="absolute inset-0 bg-gray-500 rounded-2xl transform rotate-2 scale-105 shadow-md animate-float"></div>

    {/* Foreground main card */}
    <div className="relative bg-gray-700  rounded-2xl p-8 shadow-xl transform hover:rotate-1 transition-transform duration-300 hover-scale">
      <div className="text-center">
        {/* Avatar / Icon */}
        <div className="w-32 h-32 mx-auto mb-6 bg-gray-600 rounded-2xl flex items-center justify-center animate-pulse-once delay-800">
        ...
        <div className="flex flex-wrap gap-2 justify-center">
          {['React.js', 'Node.js', 'MongoDB', 'Firebase'].map((tech, index) => (
            <span
              key={tech}
              className={`px-3 py-1 bg-gray-800 text-white border border-gray-700 rounded-full text-sm font-medium animate-bounce-in delay-${1000 + index * 100}`}
            >
              {tech}
            </span>
          ))}
